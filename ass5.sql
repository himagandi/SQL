...
CREATE TABLE genres(
 ...
 INSERT INTO directors VALUES (1000, 'V.V.Vinayak'),(1001,'Venkat Prabhu'),(1002,'Pawan'),(1003,'Sukumar'),
(1004,'Karan Johar'),(1005,'David Ayer'),(1006,'Prashanth Neel'),(1007,'S.S.Rajamouli');
  
 INSERT INTO movies VALUES ( 1, 'Chatrapati', '2023', 1000),(2, 'Custody', '2023' , 1001),(3, 'Virupaksha', '2023', 1002), 
(4, 'Pushpa', '2022', 1003), (5, 'Student of year', '2009', 1004),(6, 'Sita Ramam','2022',1005),(7, 'Jathiratnalu','2023',1006),(8,'RRR','2022',1007),(9,'Bahunali-1','2015',1007);
